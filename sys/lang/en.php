...
//    $TEXT['action-join'] = "Регистрация";
    ...
    $TEXT['search-filters-online'] = "Online now";
    ...
    $TEXT['action-hide'] = "Hide";

    // For version 6.5

    $TEXT['label-empty-wall-desc'] = "Use the toggle to change the post feed mode.";
    ...
    $TEXT['label-search-empty-desc'] = "Try changing your search filters.";

    // For version 7.0

    $TEXT['label-reaction-0'] = "Like";
    $TEXT['label-reaction-1'] = "Care";
    $TEXT['label-reaction-2'] = "Haha";
    $TEXT['label-reaction-3'] = "Wow";
    $TEXT['label-reaction-4'] = "Sad";
    $TEXT['label-reaction-5'] = "Angry";

    $TEXT['label-reacted-your-post'] = "reacted to your post.";

    $TEXT['label-all'] = "All";

    // For version 7.2

    $TEXT['page-profile-deactivation-sub-title'] = "Leave us?<br>If you continue, then all your personal data as well as content (for example: private messages, notifications, posts, comments, etc.) created by you will be permanently deleted! You will not be able to restore your account and data! In the future, if you wish to return, you will have to create a new account!";
    $TEXT['msg-error-deactivation'] = "Something went wrong... Please try again later..";

    $TEXT['label-login-create-promo'] = "Your account was created during authorization using the OAuth protocol. Your account has been provided with an auto-generated login. You can change your account login and create a password to personalize your profile, and it will also allow authorization with a password and login!";
    $TEXT['label-login-create-promo-2'] = "To be able to manage your connections you must create a username and password for your account! This will make your account independent of the Oauth protocol and will allow you to log in with your username and password!";
    $TEXT['label-login-create'] = "Create Login and Password";
    $TEXT['label-login-create-sub-title'] = "Enter the desired name for your login, and then create a password (only Latin letters and numbers, must begin with a letter). Take this seriously: 1) it will be impossible to change your login in the future, 2) you can use this data to log in to your account!";
    $TEXT['label-login-current'] = "Current Login";
    $TEXT['label-login-new'] = "New Login";

    $TEXT['label-login-create-error'] = "Login wrong format or already taken";
    $TEXT['label-login-create-success'] = "You have successfully created a username and password!";
    $TEXT['label-password-old-error'] = "Old password is wrong format or incorrect";

    // For version 7.6

    $TEXT['label-auth-phone-title'] = "Authorization by phone number";
    $TEXT['label-auth-phone-subtitle'] = "Select your country from the list and then enter your mobile phone number";
    $TEXT['label-auth-terms-promo'] = "By continuing, you agree to our ";
    $TEXT['label-auth-phone'] = "Continue with Phone Number";
