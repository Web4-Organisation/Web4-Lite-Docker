<?php
    ...
    $TEXT['search-filters-online'] = "Онлайн сейчас";
    ...
    $TEXT['action-hide'] = "Не показывать";

    // For version 6.5

    $TEXT['label-empty-wall-desc'] = "Используйте переключатель, чтобы изменить режим ленты постов.";

    $TEXT['label-month-time'] = "На 30 дней";
    $TEXT['label-life-time'] = "На всегда";
    ...
    $TEXT['action-go'] = "Перейти";

    $TEXT['label-search-empty-desc'] = "Попробуйте изменить фильтры поиска.";

    // For version 7.0

    $TEXT['label-reaction-0'] = "Нравится";
    $TEXT['label-reaction-1'] = "Мы вместе";
    $TEXT['label-reaction-2'] = "Ха-ха";
    $TEXT['label-reaction-3'] = "Ух ты!";
    $TEXT['label-reaction-4'] = "Сочувтсвую";
    $TEXT['label-reaction-5'] = "Возмутительно";

    $TEXT['label-reacted-your-post'] = "отреагировал(а) на ваш пост.";

    $TEXT['label-all'] = "Все";

    // For version 7.2

    $TEXT['page-profile-deactivation-sub-title'] = "Покидаете нас?<br>Если вы продолжите, то все ваши личные данные а также контент (например: личные сообщения, уведомления, посты, комментарии и т.д.) созданный вами будет навсегда удален! Вы не сможете восстановить свой аккаунт и данные! В будущем, если вы пожелаете вернуться - вам придется создавать новый аккаунт!";
    $TEXT['msg-error-deactivation'] = "Что-то пошло не так... Пожалуйста попробуйте позже..";

    $TEXT['label-login-create-promo'] = "Ваш аккаунт был создан при авторизации с помощью OAuth протокола. Вашему аккаунты был предоставлен автоматично сгенерированный логин. Вы можете сменить логин (имя пользователя) вашего аккаунт и создать пароль, чтобы придать своему профилю индивидуальность, а также это сделает возможным авторизацию с помощью пароля и логина (имя пользователя)!";
    $TEXT['label-login-create-promo-2'] = "Чтобы иметь возможность управлять вашими соединениями вы должны создать логин и пароль для вашего аккаунта! Это сделает Ваш аккаунт независимым от протокола Oauth и даст возможность авторизироватся с помощью логина и пароля!";
    $TEXT['label-login-create'] = "Создать логин и пароль";
    $TEXT['label-login-create-sub-title'] = "Введите желаемое имя для вашего логина, а затем придумайте пароль (только латинские буквы и цифры, должен начинаятся с буквы). Отниситесь к этому серьезно: 1) в дальнейшем логин будет невозможно сменить, 2) эти данные вы сможете использовать для авторизации в вашем аккаунте!";
    $TEXT['label-login-current'] = "Текущий логин (имя пользователя)";
    $TEXT['label-login-new'] = "Новый логин (имя пользователя)";

    $TEXT['label-login-create-error'] = "Логин неправильного формата или уже занят";
    $TEXT['label-login-create-success'] = "Вы успешно создали логин и пароль!";
    $TEXT['label-password-old-error'] = "Старый пароль неправильного формата или недействителен";

    // For version 7.6

    $TEXT['label-auth-phone-title'] = "Авторизация по номеру телефона";
    $TEXT['label-auth-phone-subtitle'] = "Выберите свою страну из списка, а затем введите номер своего мобильного телефона.";
    $TEXT['label-auth-terms-promo'] = "Продолжая, вы соглашаетесь с нашими ";
    $TEXT['label-auth-phone'] = "Продолжить с номером телефона";