...
class draw extends db_connect
{
    ...
    static function post($post, $LANG, $helper = null, $showComments = false, $menuType = 0, $page_id = 0)
    {
        ...
        <div class="card <?php if (isset($post['admin_account'])) echo "admin"; ?>" data-id="<?php echo $post['id']; ?>">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <?php
                            ...
                            if ($menuType == 0) {
                                ...
                                if (isset($post['admin_account'])) {

                                    ?>
                                        <a class="dropdown-item" href="javascript:void(0)" onclick="Post.hide('<?php echo $post['id']; ?>'); return false;"><?php echo $LANG['action-hide']; ?></a>
                                    <?php
...
<!-- href="/<?php //echo $post['fromUserUsername']; ?>/post/<?php //echo $post['id']; ?>/people"                   -->
                    <a class="item-likes-count item-reactions-count <?php if ($post['likesCount'] == 0) echo 'gone'; ?>" data-toggle="modal" data-target="#reactionsModal" href="javascript:void(0)" data-id="<?php echo $post['id']; ?>">
                        <img class="icon-reactions" alt="reactions" src="/img/reactions/reactions.png"/>
                        <span class="likes-count" data-id="<?php echo $post['id']; ?>"><?php echo $post['likesCount']; ?></span>
                    </a>
                ...
                <div class="item-footer">
                    <div class="item-footer-container" data-id="<?php echo $post['id']; ?>">

                        <span class="item-footer-button">
                            <a class="item-reaction-button item-like-button item-footer-button noselect <?php if ($post['myLike']) echo "active"; ?>" data-value="<?php echo $post['myLikeType']; ?>" data-id="<?php echo $post['id']; ?>">

                                <?php

                                    switch ($post['myLikeType']) {

                                        case 1: {

                                            ?>
                                                <i class="iconfont icofont-heart-eyes mr-1"></i>
                                            <?php

                                            echo $LANG['label-reaction-1'];
                                        ...
                                        case 2: {
                                            ...
                                            ?>
                                                <i class="iconfont icofont-laughing mr-1"></i>
                                            <?php

                                            echo $LANG['label-reaction-2'];
                                        ...
                                        case 3: {
                                            ...
                                            ?>
                                                <i class="iconfont icofont-open-mouth mr-1"></i>
                                            <?php

                                            echo $LANG['label-reaction-3'];
                                        ...
                                        case 4: {
                                            ...
                                            ?>
                                                <i class="iconfont icofont-crying mr-1"></i>
                                            <?php

                                            echo $LANG['label-reaction-4'];
                                        ...
                                        case 5: {
                                            ...
                                            ?>
                                                <i class="iconfont icofont-angry mr-1"></i>
                                            <?php

                                            echo $LANG['label-reaction-5'];
                        ...
                        <?php
                            ...
                            if (auth::isSession() && $post['fromUserId'] != auth::getCurrentUserId() && $post['fromUserId'] != 0) {
                ...
                if ($showComments) {
                    ...
                    <div class="items-list comments-list" data-id="<?php echo $post['id']; ?>">
                        ...
                        if ($commentsCount > 3) {
                            ...
                            ?>
                            <a data-id="<?php echo $post['id']; ?>" onclick="Comments.more('<?php echo $post['id']; ?>', '2', '<?php echo $data['commentId']; ?>'); return false;" class="get_comments_header noselect comment-loader">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <?php
                        ...
                        if (strlen($profile['location']) > 0) {
                            ...
                            ?>
                            <div class="grid-location">
                                <h5><i class="iconfont icofont-at"></i> <?php echo $profile['username']; ?></h5>
                            </div>
                            <?php
                        }
                    ?>
    ...
    static function communityItem($item, $LANG, $helper = null)
    {
        ...
        <div class="card-item classic-item default-item extended-list-item" data-id="<?php echo $item['id']; ?>">
            <div class="card-body">
                <span class="card-header px-0 pt-0 border-0">
                    ...
                    <div class="card-content">
                        <span class="card-title">
                            <a href="/<?php echo $item['username']; ?>"><?php echo $item['fullname']; ?></a>
                            <?php
                        ...
                        <span class="card-subtitle"><?php echo $item['followersCount']." ".$LANG['label-community-followers']; ?></span>
                    </div>
                    <span class="card-controls">
                        <?php
                            ...
                            if (auth::getCurrentUserId() != 0 && auth::getCurrentUserId() == $item['accountAuthor']) {
                                ...
                                ?>
                                    <a href="/<?php echo $item['username']; ?>" class="button secondary"><?php echo $LANG['action-go']; ?></a>
                                    <a href="/<?php echo $item['username']; ?>/settings" class="button primary"><?php echo $LANG['action-edit']; ?></a>
                                <?php
    ...
    static function marketItemPreview($item, $LANG, $helper = null)
    {
        ...
        <div class="card-item classic-item default-item extended-list-item" data-id="<?php echo $item['id']; ?>">
            <div class="card-body">
                <span class="card-header px-0 py-0 border-0">
                    <a href="/<?php echo $item['fromUserUsername']; ?>/market/<?php echo $item['id']; ?>">
                        <span class="card-icon square-icon" style="background-image: url(<?php echo $itemPhotoUrl; ?>);"></span>
                    </a>
                    <div class="card-content">
                        <span class="card-title">
                            <a href="/<?php echo $item['fromUserUsername']; ?>/market/<?php echo $item['id']; ?>"><?php echo $item['itemTitle']; ?></a>
                        </span>
                        <span class="card-subtitle"><?php echo $item['price']." $"; ?></span>
                        <span class="card-subtitle"><?php echo  $item['itemContent']; ?></span>
                    </div>
                    <span class="card-controls">
                        <?php
                        ...
                        if (auth::getCurrentUserId() != 0 && auth::getCurrentUserId() == $item['fromUserId']) {
                            ...
                            ?>
                                <a href="/<?php echo $item['fromUserUsername']; ?>/market/<?php echo $item['id']; ?>" class="button secondary"><?php echo $LANG['action-go']; ?></a>
                                <a onclick="Market.deleteItem('<?php echo $item['id']; ?>'); return false;" href="javascript: void(0);" class="button primary"><?php echo $LANG['action-remove']; ?></a>
                            <?php
