 ...
 */
        ...
        if ($inbox_loaded != 0) {
            ...
            if ($result['inbox_loaded'] < $inbox_all) {
                ...
                <header class="top-banner loading-banner">
                    ...
                    <div class="prompt">
                        <button onclick="Items.more('/explore', '<?php echo $result['itemId']; ?>'); return false;" class="button more loading-button"><?php echo $LANG['action-more']; ?></button>
                    </div>
    ...
    $page_title = $LANG['page-explore']." | ".APP_TITLE;
                ...
                <div class="main-content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $LANG['page-explore']; ?></h3>
